...
DESCRIPTION         = 'Theano extension based on MIT code'
...
def write_version_py(filename=os.path.join('theano_chi2sf',
                                           'generated_version.py')):
    cnt = """
# THIS FILE IS GENERATED FROM THEANO_CHI2SF SETUP.PY
